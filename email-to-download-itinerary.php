...
if( ! defined( 'ED_MENU_POSITION' ) ) define( 'ED_MENU_POSITION', 85 );
    ...
    class ED_Plugin{
        ...
        public function __construct() {
            ...
            $this->_defaults = array(
                            ...
                            'Thank you for downloading our itinerary! We have generated the download link for you.<br/>'.
                            'Please click on the following link to download the product.'.
                            'Please note that, this link will be active for {{download_expire}} hour(s).<br/>'.
        ...
        public function init() {
            ...
            $labels = array(
        		...
        		'menu_name'          => _x( 'Itineraries', 'admin menu', 'email-to-download' ),
        ...
        public function ed_settings_menu() {
            ...
            add_submenu_page( 'edit.php?post_type=' . $this->ed->get_post_type(), __( 'View Leads', 'email-to-download' ), __( 'View Leads', 'email-to-download' ), 'manage_options', 'email-to-download-leads', array( &$this, 'email_to_download_leads' ) );
        }
